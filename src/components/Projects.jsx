            ...
            >
              <div className="image-container">
                ...
                >
                  <div className="overlay-buttons">
                    ...
                    {project.demoUrl && (
                      <a href={project.demoUrl} target="_blank" rel="noreferrer" className="overlay-btn">
              ...
              <div className="project-info">
                ...
                <div className="mobile-actions">
                  <a href={project.githubUrl} target="_blank" rel="noreferrer" className="mobile-link">
                    <Github size={18} /> GitHub
                  </a>
                  {project.demoUrl && (
                    <a href={project.demoUrl} target="_blank" rel="noreferrer" className="mobile-link">
                      <ExternalLink size={18} /> Demo
                    </a>
                  )}
                </div>
